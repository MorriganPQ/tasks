...
public class TrelloFacadeTest {
    ...
    public void shouldNotCreateCard() {
        // Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test", "Facade test", "top", "32");
        TrelloCard trelloCard = new TrelloCard("Test", "Facade test", "top", "32");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("128", "Test", "http://test.com");
        ...
        assertEquals("128", newCard.getId());
